...
<#
.DESCRIPTION
This is a script that will recreate the partition structure that came on an HP EliteBook Dragonfly G4 factory image.
.LINK
...
if ($env:SystemDrive -eq 'X:') {
    ...
    $ImageRoot = 'E:\HP\Images\Dragonfly-5CG32818YV'
    $ImageDescription = 'Dragonfly-5CG32818YV'
